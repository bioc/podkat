...
\begin{description}
\item[Version 1.17.1:] \hfill
\begin{itemize}
\item changed \verb+summary()+ method for \texttt{VariantAnnotation} class
  in order to stay compatible with \verb+print()+ method in
  \texttt{GenomicRanges} package
\item corresponding minor adaptations in documentation and package vignette
\end{itemize}
\item[Version 1.17.0:] new branch for Bioconductor 3.10 devel
\item[Version 1.16.0:] release as part of Bioconductor 3.9
\item[Version 1.15.1:] \hfill
\begin{itemize}
\item changed \texttt{Rsamtools} API to \texttt{Rhtslib} API
\end{itemize}
\item[Version 1.5.3:] \hfill
...
\item[Version 1.10.0:] release as part of Bioconductor 3.6
...
\item[Version 1.5.4:] \hfill
\begin{itemize}
\item fix in vignette code that became necessary because of a change in
  the hg38 transcript annotation
\end{itemize}
\item[Version 1.5.3:] \hfill
\begin{itemize}
\item \verb+readRegionsFromBedFile()+ now allows for including metadata columns
\item corresponding changes in documentation
\item fix of call to method \verb+rowRanges()+ into suggested package
\item fix of citation info file
\item fix of \verb+inst/NEWS+
\end{itemize}
...
\item[Version 1.3.1:]\hfill\mbox{ }
  \begin{itemize}
  \item added missing method \verb+readVariantInfo()+ for signature
  `\verb+character+', `\verb+GRanges+'
  \item minor streamlining of source code of \verb+readGenotypeMatrix()+
  \item corrections of namespace imports
  \end{itemize}
\item[Version 1.3.0:] new branch for Bioconductor 3.3 devel
\item[Version 1.2.0:] release as part of Bioconductor 3.2
\item[Version 1.1.3:]\hfill\mbox{ }
  \begin{itemize}
  \item further fix of \verb+weights()+ method for signature
    `\verb+AssocTestResultRanges+'
  \end{itemize}
\item[Version 1.1.2:]\hfill\mbox{ }
  \begin{itemize}
  \item fix of \verb+weights()+ method for signature
    `\verb+AssocTestResultRanges+'
  \end{itemize}
\item[Version 1.1.1:]\hfill\mbox{ }
  \begin{itemize}
