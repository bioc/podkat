//
// File qfc.cpp as taken from the CompQuadForm package
// Downloaded from CRAN on 2015-03-06
// Package version 1.4.1 (2013-06-16)
//
...
#include "qfc.h" // include prototype header to enforce type checking
